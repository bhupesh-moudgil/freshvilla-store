...
# Script to generate all admin dashboard components
BASE_DIR="/Users/maropost/Documents/freshvilla/Project-files/freshvilla-customer-web/src/pages/Admin"

echo "🚀 Generating Admin Dashboard Components..."

# Create DashboardHome.jsx
cat > "$BASE_DIR/DashboardHome.jsx" << 'EOF'
...
echo "✅ Created DashboardHome.jsx"

# The script will be continued in next message due to length...
echo "📦 Component generation script created"
echo "Run: bash generate-admin-components.sh"
EOF

chmod +x /Users/maropost/Documents/freshvilla/Project-files/generate-admin-components.sh
